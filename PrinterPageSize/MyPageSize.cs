...
namespace PrinterPageSize
{
    ...
    /// 自定义打印纸类型和尺寸
    ///
    public static class MyPageSize
    {
        //调用方法
        //float width = 2100;
        //float height = 1600;
        ...
        /// <param name="paperName">纸张的自定义名称</param>
        /// <param name="width">宽度，单位0.1毫米，需要在打印机允许的尺寸之内，否则按照默认打印纸类型打印</param>
        /// <param name="height">高度，单位0.1毫米，需要在打印机允许的尺寸之内，否则按照默认打印纸类型打印</param>
